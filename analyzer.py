...
if __name__ == "__main__":
    ...
    log_expense(USER_ID, "Groceries", "Costco", 82.40, "Debit", "2025-12-18")
    log_expense(USER_ID, "Utilities", "Electric Co", 140.00, "Credit", "2025-12-20")

    # Run monthly analysis
    analyze_month(USER_ID, "2025-12-28")
